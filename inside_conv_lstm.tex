...
\begin{figure}
    ...
    \caption{Inside convolutional LSTM. Need to update colors to be consistant with LSTM. Might need to add colors to the hidden states, input an cell state matrices. Cite Precipitation Nowcasting.}
