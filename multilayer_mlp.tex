...
\caption{Multi-layer neural network. The connections between the layers are the weights. The input layer has four units, the hidden layers all have five and the output layer has three. The sketch is based on the example from \href{http://www.texample.net/tikz/examples/neural-network/}{http://www.texample.net/tikz/examples/neural-network/}}
