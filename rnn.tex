...
%Start drawing the thing...    
    ...
    \caption{Simple one layer recurrent network. $x_t$ denotes the input, $h_t$ denotes the output/ hidden state of the neuron and A denotes a artificial recurrent unit. Inspired by \href{http://colah.github.io/posts/2015-08-Understanding-LSTMs/}{http://colah.github.io/posts/2015-08-Understanding-LSTMs/}.}
    \label{fig:rnn}
\end{figure}